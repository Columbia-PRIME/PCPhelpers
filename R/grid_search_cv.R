...
#'
#' \code{grid_search_cv} conducts a cross-validated grid search of the 
#' parameters for a given PCP function, given a data matrix \code{mat} and settings of parameters to search through.
...
#'    \item{\code{constants}}{A list containing those arguments initially passed as constant values when calling \code{grid_search_cv}.}
#' }
#' @seealso \code{\link{random_search_cv}}, \code{\link{bayes_search_cv}}, and \code{\link{print_gs}}
#' @examples
#' 
...
#' # run the grid search:
#' 
#' param_grid.out <- grid_search_cv(mat, pcp_func = root_pcp_na, grid_df = param_grid, cores = 4, perc_b = 0.2, runs = 20, progress_bar = TRUE, file = NULL)
#' 
